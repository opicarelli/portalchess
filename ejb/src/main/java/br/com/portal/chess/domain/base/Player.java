...
public class Player implements Serializable {
    ...
    @OneToOne
    @JoinColumn(name = "user_id", nullable = false, foreignKey = @ForeignKey(name = "player_user_fk"))
    public User getUser() {
        return user;
    }
    ...
    @ManyToMany
    @JoinTable(name = "CLUB_PLAYER_T",
        joinColumns = { @JoinColumn(name = "player_id", referencedColumnName = "id") },
        inverseJoinColumns = { @JoinColumn(name = "club_id", referencedColumnName = "id") },
        foreignKey = @ForeignKey(name = "club_player_player_fk"),
        inverseForeignKey = @ForeignKey(name = "club_player_club_fk"))
