/**
 * Ukrainian translation for bootstrap-datepicker Igor Polynets
 */
;
(function($) {
    $.fn.datetimepicker.dates['ua'] = {
        ...
        months : [ "Cічень", "Лютий", "Березень", "Квітень", "Травень", "Червень", "Липень", "Серпень", "Вересень", "Жовтень", "Листопад",
                "Грудень" ],
